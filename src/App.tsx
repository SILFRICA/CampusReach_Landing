    ...
    <>
      ...
      <div className="flex justify-center w-full py-4 bg-cr-gray-200 second-section">
        <div className="flex flex-col items-center w-5/6 gap-5 mt-10">
          ...
          <div className="grid w-full grid-rows-2 gap-10 md:grid-cols-2">
            <AccelCard
              ...
              cnames="md:h-[400px] bg-cr-pink-300"
              textWidth="w-[70%]"
              image={GroupImg1}
            />
            <AccelCard
              ...
              cnames="md:h-[400px] bg-cr-light-green"
              textWidth="w-[70%]"
              image={GroupImg2}
            />
            <AccelCard
              ...
              cnames="md:h-[250px] bg-cr-gray-300 px-2"
            ...
            <AccelCard
              ...
              cnames="md:h-[250px] bg-cr-yellow-200 px-2"
              textWidth="text-left grid w-5/6 place-items-start"
              image=""
            />
            <div className="col-span-2 md:h-[350px] bg-white h-52 rounded-xl flex justify-center items-center md:-mt-40">
              <div className="grid grid-cols-2 gap-4 place-items-center h-2/3">
